  ...
  return (
    <div className="h-[46px] bg-editor-bg border-b border-editor-line flex items-center justify-between px-4 select-none shrink-0 whitespace-nowrap overflow-hidden">
      ...
      <div className="flex items-center gap-4 flex-1 min-w-0 mr-4">
        <span className="font-bold text-sm text-editor-fg tracking-wide shrink-0 hidden sm:block">
          {t("app.title")}
        </span>
        <span className="font-bold text-sm text-editor-fg tracking-wide shrink-0 sm:hidden">
          HR
        </span>
      ...
      <div className="flex text-xs items-center gap-4 flex-1 justify-end min-w-0 ml-4">
        <div
          className="flex  items-center gap-2 bg-editor-line/20 px-3 py-1.5 rounded border border-editor-line/50 cursor-help shrink min-w-0 max-w-[200px]"
        ...
        >
          ...
          <span className="truncate">
            {t("titlebar.semantic")}: "Order Timeout"
          </span>
        </div>

        <div
          className="flex items-center gap-2 text-gray-400 hover:text-white cursor-pointer transition-colors shrink-0 hidden lg:flex"
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <div title={t("titlebar.sync_online")}>
            <Circle
              size={10}
              className="text-editor-success fill-editor-success"
            />
          </div>
        </div>
      </div>
