...
const translations = {
  zh: {
    ...
    'diffview.comments': '评论',
    'diffview.show_comments': '显示评论',
    'comment.placeholder': '添加评论...',
    'comment.add_placeholder': '添加评论...',
    'comment.edit_placeholder': '编辑评论...',
    'comment.reply_placeholder': '回复给 {{author}}...',
    'comment.add': '添加评论',
    'comment.adding': '添加中...',
    'comment.added_success': '评论添加成功',
    'comment.add_error': '添加评论失败',
    'comment.edit': '编辑',
    'comment.delete': '删除',
    'comment.delete_confirm': '确定要删除这条评论吗？',
    'comment.reply': '回复',
    'comment.no_comments': '暂无评论',
    'comment.shortcuts': 'Ctrl+Enter 提交，Esc 取消',
    ...
    'rightpanel.tab.tasks': '任务',
    'rightpanel.tab.templates': '模板',
  ...
  en: {
    ...
    'diffview.comments': 'Comments',
    'diffview.show_comments': 'Show Comments',
    'comment.placeholder': 'Add a comment...',
    'comment.add_placeholder': 'Add comment...',
    'comment.edit_placeholder': 'Edit comment...',
    'comment.reply_placeholder': 'Reply to {{author}}...',
    'comment.add': 'Add Comment',
    'comment.adding': 'Adding...',
    'comment.added_success': 'Comment added successfully',
    'comment.add_error': 'Failed to add comment',
    'comment.edit': 'Edit',
    'comment.delete': 'Delete',
    'comment.delete_confirm': 'Are you sure you want to delete this comment?',
    'comment.reply': 'Reply',
    'comment.no_comments': 'No comments yet',
    'comment.shortcuts': 'Ctrl+Enter to submit, Esc to cancel',
    ...
    'rightpanel.tab.tasks': 'Tasks',
    'rightpanel.tab.templates': 'Templates',
